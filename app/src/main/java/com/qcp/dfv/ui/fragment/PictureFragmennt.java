...
import com.qcp.dfv.adapter.PictrueAdapter;
...
public class PictureFragmennt extends BaseFragment {
    ...
    ArrayList<PictrueList> lists;
    PictrueAdapter adapter;
    ...
    private void initListData() {
        lists = new ArrayList<>();
        adapter = new PictrueAdapter(getActivity(), lists);
        //设置布局管理器，默认纵向滑动
