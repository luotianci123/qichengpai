...
import com.qcp.dfv.ui.activity.HotActivity;
...
public class RecommendedAdapter extends RecyclerView.Adapter<RecommendedAdapter.ViewHolder> {
    ...
    private ArrayList<RecommendedList> list;
    ...
    public RecommendedAdapter(Context context, ArrayList<RecommendedList> list) {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        holder.tabRly.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            tabRly = (RelativeLayout) itemView.findViewById(R.id.tab_rly);
        }
    }
